...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => DellaAdeliaDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-Della Adelia (6SIA6)'),
        ),
        body: LoginPage(),
      ),
    );
...
class DellaAdeliaDataTable extends StatefulWidget {
  _DellaAdeliaDataTableState createState() => _DellaAdeliaDataTableState();
}

class _DellaAdeliaDataTableState extends State<DellaAdeliaDataTable> {
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Della Adelia", ),
      DataMahasiswa(
